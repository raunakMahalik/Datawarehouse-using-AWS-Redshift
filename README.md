...
**NOTE:** It is worthwhile mentioning that the The SERIAL command in PostgreSQL for auto-incremented fields is not supported in AWS Redshift. The equivalent command in Redshift is IDENTITY(0,1).
